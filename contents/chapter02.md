...
本章旨在系統性回顧並評析多元旅運整合服務（Mobility as a Service, MaaS）與公共運輸使用者行為分析之相關研究，以定位現有知識的核心貢獻與仍待深入之議題。首先，將說明 MaaS 的定義、概念演變與各國試辦計畫之實證成果，勾勒出 MaaS 研究與實務推動的現況與缺口。其次，聚焦於使用者層面，彙整關於潛在採用者、使用者特性與實際使用行為的研究成果，藉此描繪不同族群於 MaaS 生態系中的角色與需求。最後，延伸至公共運輸使用者行為之文獻，透過電子票證資料與使用者旅運行為特徵等方向切入，了解可供 MaaS 研究借鏡的方法與觀察，期為後續研究方法探索與實務應用奠定完善且具體的基礎。
...
為區分不同程度的 MaaS 整合服務，Sochor et al.（2018）提出 MaaS 整合成熟度模型，將其分為五個層級：第0級為無整合，僅為單一運具服務；第1級為資訊整合，如 Google Maps、Moovit 提供多模式路線規劃；第2級整合預訂與支付功能，例如台灣的 T-Express；第3級則為服務整合，能提供月租型出行套票，如芬蘭 Whim 或高雄 MeN Go；最高的第 4 級則進一步將社會目標納入，例如鼓勵永續移動、改善空氣品質與促進社會公平。此分類架構不僅幫助辨識 MaaS 系統發展階段，也有助於政策制定者與服務提供者釐清各自角色與責任。

然而在實際推動過程中，全面整合型 MaaS 系統在制度、資源與商業模式上往往面臨高度挑戰，因此 Pickford 與 Chung（2019）提出「MaaS Lite」概念，主張從較簡化的模式出發，先行整合地方性常見出行需求（如接駁巴士與捷運），以降低推動門檻與導入風險。整體而言，MaaS 不僅是一種技術或商業創新，更被視為實現永續都市交通的重要策略。藉由促進運具間的轉乘便利性與資源共享，MaaS 有望降低私人車輛依賴，提升運輸系統效率，進而達成減碳與改善都市移動品質之目標（Gould, Wehrmeyer, & Leach, 2015；Wong, Hensher, & Mulley, 2020）。

於先前各國的MaaS實際試辦計畫中可以觀察到，MaaS 系統展現出了其降低私人運具使用的潛力，例如。芬蘭赫爾辛基的 Whim 營運資料顯示，該系統使用者中有 95.2 % 的旅次依賴公共運輸使用， 3.8 % 透過計程車與共享汽車達成旅次目的，且約有 68 % 的旅次集中於可及性最高之公共運輸廊帶，證明 MaaS 作為強化公共運輸網路之有效手段，並非取代公共運輸；同時，Whim 使用者在 1 公里內首末段大量使用共享自行車與計程車，其中 97 % 的單車旅次少於 30 分鐘、87 % 之計程車使用旅次短於 5 公里，於芬蘭的案例中，著實呈現「以公共運輸為主、共享為輔」之多模式運輸型態 (Ramboll, 2019)。並於澳洲雪梨 MaaS 試辦計畫將公共運輸月票、巴士與火車折抵設定為所有MaaS套餐方案之基礎，並以計程車與共享汽車額度作為附加價值提供使用者運用，凸顯出「整合票證」在吸引早期使用者與落實永續目標上的關鍵性；其研究結果進一步證實，若使用者選擇訂閱方案的機率每增加 1 個百分點，月度私家車行駛距離平均減少約 67 公里 (Hensher et al., 2021)。且於瑞典 UbiGo 與奧地利 Smile 等較早期的MaaS試辦計畫中，研究發現 44 % 與 21 % 的計畫參與者在六個月內降低私家車使用；研究指出，唯有達到資訊、票證、付款與客製化套票方案等因素的高度整合（Integration Level 3–4），才能真正且有效地讓使用者的出行模式進行轉移 (Durand et al., 2018)。

綜合而言，透過過去MaaS試辦計畫進行的實證研究，皆一致證明「公共運輸為 MaaS 骨幹、搭配多模式運輸系統及第一/最後一哩路之接駁與訂閱制的套票銷售模式」能有效減少使用者對私人運具的依賴，並促進城市間公共運輸系統的使用率及使用者的使用意願，並更能去體現出MaaS服務出現的核心概念，透過一個平台去完成日常所需的運輸服務。
...
綜上所述，從潛在使用者及使用意願到以使用特性及目的進行之行為預測研究，於 MaaS 使用者行為特性之研究：以通勤目的為主並透過多運具組合之公共運輸使用、科技接受度及環保意識較高之使用者，是為MaaS推廣的主要受眾。下節將進一步%% 轉向以實際使用行為紀錄為基礎的研究，探討 MaaS 使用行為的時空特性與群體異質性，彌補僅從意願推論而未驗證實際行為的限制。 %%回顧有關國內MaaS發展的歷程與國內相關研究，用以詳實理解目前尚有哪些研究缺口待填補。

### 國內MaaS發展與相關研究

#### 國內MaaS發展

國內MaaS發展首先由**公共運輸行動服務(MaaS, Mobility as a Service)發展應用分析與策略規劃** 開始進行MaaS系統服務的雛型，透過兩個主要的MaaS系統：都市型MeNGo與城際型UMAJI 作為國內 MaaS 系統的發展開端，於高雄與北北宜地區開始實行，後續於其他縣市開始推廣各自的MaaS系統。以下為國內目前主要之MaaS系統服務，主要去區分為，城際整合、都會型、偏鄉型與觀旅型等等。

##### 城際型

1. UMAJI - 遊買集

交通部於民國106年開始在北北宜推行MaaS計畫「臺北都會區往來宜蘭縣交通行動服務建置及經營計畫」，此為第一代的UMAJI系統，整合了民眾交通所需、即時路況資訊查詢、旅運行程規劃、預估旅行時間、最佳行駛路徑、客運搭乘票卷購買等，提供使用者跨平臺之服務整合平臺、一站式大眾運輸交通服務解決方案。並於民國108年推動「UMAJI交通行動服務經營計畫」也就是第二代的UMAJI系統，期以臺灣高鐵作為骨幹運輸，並結合其他接駁運具、共享運具等，將執行方向由G2C瞄準「G2B」，予以民間產業及地方政府使用，以利發展各產業及地方特色之MaaS服務。
...
2. TBS台北轉運站
TBS為城際運輸MaaS服務之代表，臺北轉運站為國道客運轉運站，自民國107年起積極發展智慧行動票證暨轉運站加值消費整合服務，發展城際MaaS服務TBS 應用程式App，提供全台國道客運線上訂票、選座位、付款、QR Code登車、退/換/分票等功能，除此之外，更持續發展一系列交通票券，包含學生專車、屏東185郵輪雙層巴士、臺灣好行、澎湖船票、小琉球船票、龜山島賞鯨、武陵櫻花祭套裝行程、國慶煙火套裝行程、花蓮公車套票等。是目前結合公共運輸與觀光遊程，且跨足陸路運輸與海運與觀光之MaaS平台，目前已有超過32萬名會員。

##### 都會型

3. 高雄MeNGO

自民國105年度起，交通部運輸研究所辦理相關MaaS規劃及推廣計畫，並於民國107年高雄正式推行「MeN▶GO卡」使高雄市成為亞洲第一個MaaS示範服務區，整合高雄市轄內的捷運、輕軌、公路客運、公車、渡輪、共享自行車、共享電動車、共享電動機車、計程車及停車轉乘的停車場等，後續更與臺南及臺東推出相關公車通勤月票與24、48、72小時QR時數票，並與臺灣好行合作推出24、48、72小時暢遊券供民眾更多選擇；高雄MeN▶GO透過支付系統的整合、優惠套票的設計、異業結盟等，使得會員數及使用人數皆持續穩定成長。

除此之外，因應民國112年中央政府推出「TPASS行政院通勤月票」，因此原本嘉惠通勤通學族群之MeN▶GO月票亦與其整合，提供相關族群更優惠之價格與服務。彙整交通部運輸研究所於民國111年出版「交通行動服務MaaS縣市推廣與輔導計畫研究案」及最新發展，本計畫本研究將MeN▶GO發展歷程彙整如下：
...
為解決臺東地區公共運輸覆蓋不足、服務效率低落之問題，臺東縣政府自民國103年起陸續推動市區公車與轉運站建置，並於104年起爭取交通部「需求反應式公共運輸服務計畫」，導入預約接駁服務，改善偏遠地區交通正義。隨著觀光需求日增、居民生活需求多元，臺東TTGO 平臺應運而生，以智慧科技整合各式交通資源，發展出兼具「交通接駁」、「觀光體驗」與「在地照顧」的行動服務架構。

TTGO平臺核心理念為推動「臺東慢經濟」，倡導漫遊、慢活、慢食的旅遊與交通體驗，並由政策端、需求端、科技端與服務端四面向協力推動。科技端以MaSS（Mobility as a Social Service）為基礎，建置「TTGO交通預約媒合平台」，整合火車、客運、公車、幸福巴士、計程車等多元運具與預約服務，達成在地居民與觀光客雙向需求的滿足。服務端則連結旅遊行程與地方資源，提供含交通、食宿、購物之整合服務。政策端強調以人本思維為核心，透過調查需求與交通痛點，逐步改善基礎運輸體系。

TTGO平台發展可分為三階段：第一階段（110年）進行系統建置與需求訪談；第二階段（111年）整合多元服務上線營運，包含幸福巴士、幸福小黃、噗噗共乘等預約共乘服務；第三階段（112–113年）擴大涵蓋長照、復康巴士，提升服務彈性並跨鄉整合，朝向全方位MaaS平台發展。平台功能涵蓋：一、提供即時路線與轉乘資訊，二、整合預約接駁服務，三、查詢訂單與可用車輛資訊等三大核心模組。

4. Taichung GO

根據交通部運輸研究所於民國111年出版「交通行動服務MaaS縣市推廣與輔導計畫研究案」，臺中Maas計畫之相關專案起始於民國110年，該案初期規劃以通勤通學為主，後來經蒐集學生族群的使用意見後得知因臺中市公車受惠於10公里免費政策，在通勤通學方面尚無使用Maas月票之需求，因此目前臺中市Maas服務的主要發展方向轉向參考高雄市成功案例，將目標族群轉往為觀光遊憩使用者，以提高使用者的購買誘因。

臺中MaaS服務平台—Taichung Go 套票

Taichung Go 套票為時數型QR Code套票，該套票結合臺中捷運、公車等公共運具，票價不同依據發售24、48及72小時無限次數搭乘之方案套票，該時數型套票內容如下表表 2.3-2：

表 2.3-2 Taichung Go時數型套票內容

|      |      |                                                                                                                                                                                                                                                                            |
| ---- | ---- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 方案   | 票價   | 運具                                                                                                                                                                                                                                                                         |
| 24小時 | 180元 | 自Taichung go套票啟用後一定期間內(24/48/72小時)無限次搭乘公車及捷運。<br><br>  <br><br>- 臺中市公車(僅限六條幹線公車、八條觀光客運路線) <br>    <br>- 註1：不限次數、不限距離<br>    <br><br>  <br>  <br><br>- 臺中捷運：不限次數、不限距離<br>    <br>- 註 1：臺中市公車指定路線:六條幹線公車(100、200、300、500、700及900路)及八條觀光公車(11、66副、151、153、309、865、866及888路)路線 |
| 48小時 | 280元 |                                                                                                                                                                                                                                                                            |
| 72小時 | 380元 |                                                                                                                                                                                                                                                                            |

3. 菊島智旅平台

根據交通部運輸研究所於民國111年出版「交通行動服務MaaS縣市推廣與輔導計畫研究案」澎湖縣政府規劃以計程車預約服務為主軸，並輔導旅宿業協助媒合旅客與計程車，並規劃在MaaS平台整合海陸空運之即時資訊、交通船票販售及驗票服務及觀光旅運規畫服務，一同整合進該平台。此規劃案一共分為三階段，首先為平台自身的整合查詢系統建置，再來以各類服務為主，包含旅遊行程規劃和食宿整合服務，最後為多元國際整合項目的進行，詳細規劃歷程見下圖：

4. 花蓮Hualien Yo真行

花蓮縣MaaS平台在規劃時程上分為三階段，首先以編織在地跨域交通系統網為主，將當地業者及運具資訊整合，其中包含「花蓮交通e點通」、「噗噗共乘」、「Umaji」、「TDX」等，並加強基礎資料的蒐集，能使得整個平台營運所需的資訊更加完備，下階段為整合在地的多項服務，使得平台能夠提供完善的旅運交通規劃。

其中，最為重要的工項為整合運輸及觀光產業的資源，包含轉運站至景點的交通規劃、大眾運輸服務、交通時數及觀光旅遊套票的整合、電子商務功能等。最後一個階段是為行銷及推廣，其中包括串接國際行旅、異業結合、推廣行銷影片等。
